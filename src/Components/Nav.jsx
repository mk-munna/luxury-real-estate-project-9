    ...
    return (
        <div className='font-Outfit'>
            ...
            <div className="bg-[#EEFFF5] py-6">
                {/* content */}
                <div className="lg:max-w-[1200px] items-center md:max-w-screen-md flex-col lg:flex-row md:flex-row gap-8 flex mx-auto">
                    <div className="flex flex-col gap-8 lg:flex-row md:flex-row">
                        <h1 className="flex items-center gap-2 md:text-2xl justify-center text-3xl font-semibold text-primary"><img className="w-10" src="https://i.ibb.co/YjBjgNm/image-removebg-preview-1.png" alt="" /><span>Luxe Realty</span></h1>

                        <label className=" bg-white rounded-full w-[300px] mx-auto px-4  h-10 flex items-center gap-2">
                    ...
                    {/* part 3 */}
                    <div className="flex gap-6 ml-6 w-[200px]">
