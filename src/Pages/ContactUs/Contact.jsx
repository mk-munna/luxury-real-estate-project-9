            ...
            <div className='flex flex-col lg:flex-row gap-20 md:gap-20 lg:gap-[100px] mt-20'>
                <div className='lg:w-[700px] w-[300px] md:w-full'>
                    <form data-aos="fade-right" data-aos-duration="1500">
                        ...
                        <input type="text" placeholder="Your email" name="email" className="bg-gray-100 px-6 py-[14px] rounded-md focus:outline-none w-full " />
                        <br />
                        <br />
                        <p className='mb-2 font-semibold'>Phone*</p>
                        <input type="text" placeholder="Your phone" name="phone" className="bg-gray-100 px-6 py-[14px] rounded-md focus:outline-none w-full " />
                        <br />
                        <br />
                        <p className='mb-2 font-semibold'>Message*</p>
                        <textarea rows={6} cols={5} type="text" placeholder="Your message" name="message" className="bg-gray-100 px-6 py-[14px] rounded-md focus:outline-none w-full" />
                        <br />
                        <br />
