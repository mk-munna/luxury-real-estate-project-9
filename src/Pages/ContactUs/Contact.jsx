...
const Contact = () => {
    ...
    return (
        <div className='lg:mt-20 md:px-8 lg:mb-28 mt-6 mx-auto lg:w-[1000px]'>
            ...
            <div className='mt-20  flex flex-col  gap-28  lg:flex-row'>
                <form onSubmit={handleSubmit} className='max-w-[340px] md:max-w-screen-sm mx-auto lg:max-w-[600px]'>
                    ...
                    <div className='flex flex-col lg:flex-row gap-16'>
                        <div className='w-[280px] mx-auto lg:mx-0 px-6 lg:px-0'>
                            ...
                            <div className='mt-2 text-center lg:text-left'>
                                <span className='mr-4'>#Penthouse</span>
                                <span className='mr-4'>#Resort</span>
                                <span className='mr-4'>#Villa</span> <br />
                                <span className='mr-4'>#Luxury Home</span>
                            </div>
